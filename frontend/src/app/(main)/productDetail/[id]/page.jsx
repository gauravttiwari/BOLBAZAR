  ...
  useEffect(() => {
    if (
      ...
      triggerModal(
        ...
        `${productDetails.pname} added to cart`,
        true,
    ...
    if (currentUser !== null) {
      return (
        <div>
          ...
          />
          <div >
        <textarea className="border border-black pt-3" ref={reviewRef}></textarea>
        </div>
        <button 
        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">{productDetails.pdetail}</p>
              ...
              <div className="flex">
                ...
                >
                  {isInCart(productDetails) ? "Already In Cart" : "Add to Cart"}
                </button>
