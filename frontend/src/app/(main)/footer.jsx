        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white text-xl font-bold">BolBazar</span>
            </div>
            <p className="text-sm text-gray-400 mb-4 max-w-xs">
              Your one-stop destination for quality products at the best prices. Shop smarter, live better.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-gray-700 hover:bg-primary flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/productView" className="hover:text-white transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/user/ordertracking" className="hover:text-white transition-colors">Track Order</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>House No. 01, Lucknow, India</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <a href="mailto:support@bolbazar.com" className="hover:text-white transition-colors">bolbazar.mart@gmail.com</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                </svg>
                <a href="tel:1234567890" className="hover:text-white transition-colors">+91 123 456 7890</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <span className="text-2xl">💳</span>
                <span className="bg-white rounded px-2 py-1 text-xs font-bold text-emerald-600">VISA</span>
                <span className="bg-white rounded px-2 py-1 text-xs font-bold text-red-500">MC</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                <button className="bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded flex items-center gap-2 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
                  <div className="text-left">
                    <p className="text-[10px] leading-none">Download on</p>
      ...
      <div className="border-t border-gray-700 bg-gray-900">
        <div className="section-container py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-500">
            <p>© 2026 BolBazar. All rights reserved.</p>
